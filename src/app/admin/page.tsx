...
import { THEMES, STATUSES } from "@/components/MaterialForm";

const THEME_LABEL = Object.fromEntries(THEMES.map(({ value, label }) => [value, label]));
          ...
          {items.map((item) => (
            ...
            >
              <div className="flex flex-col gap-0.5 min-w-0">
                ...
                <span className="text-xs text-gray-400">{THEME_LABEL[item.theme]}</span>
              </div>
              <span
